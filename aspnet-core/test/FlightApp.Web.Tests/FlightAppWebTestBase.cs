...
{
    public abstract class FlightAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FlightAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FlightAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FlightAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FlightAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FlightAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FlightAppDbContext, Task<T>> func)
        {
            T result;
