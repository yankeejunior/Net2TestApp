        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightDestination = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FlightCodes_Passengers_PassengerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightCodes_PassengerId",
                schema: "flights",
                table: "FlightCodes",
                column: "PassengerId");
        }
