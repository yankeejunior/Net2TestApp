...
namespace FlightApp.Migrations
{
    ...
    [Migration("20230419123900_PassengersClassMealTypeAddedToPassenger")]
    partial class PassengersClassMealTypeAddedToPassenger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlightApp.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlightApp.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FlightApp.Entities.FlightCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("FlightCodes", "flights");
                });

            modelBuilder.Entity("FlightApp.Entities.Passenger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Passengers", "flights");
                });

            modelBuilder.Entity("FlightApp.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FlightApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FlightApp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FlightApp.Authorization.Roles.Role", b =>
                {
                    b.HasOne("FlightApp.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("FlightApp.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("FlightApp.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FlightApp.Entities.FlightCode", b =>
                {
                    b.HasOne("FlightApp.Entities.Passenger", "Passenger")
                        .WithMany()
